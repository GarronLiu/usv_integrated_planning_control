...
void pubSensedPoints() {
  ...
  if (kdtreeLocalMap.radiusSearch(searchPoint, _sensing_range,
    ...
    for (size_t i = 0; i < pointIdxRadiusSearch.size(); ++i) {
      ...
      pcl::PointXYZI pt_intensity;
      pt_intensity.x = pt.x;
      pt_intensity.y = pt.y;
      pt_intensity.z = pt.z;
      pt_intensity.intensity = 0.0;
      localMap.points.push_back(pt_intensity);
    }
  } else {
...
int main(int argc, char** argv) {
  ...
  n.param("map_genearator/init_state_x", _init_x, 0.0);
  n.param("map_genearator/init_state_y", _init_y, 0.0);

  n.param("map_genearator/x_size", _x_size, 50.0);
  n.param("map_genearator/y_size", _y_size, 50.0);
  n.param("map_genearator/z_size", _z_size, 5.0);
  n.param("map_genearator/obs_num", _obs_num, 30);
  n.param("map_genearator/resolution", _resolution, 0.1);
  n.param("map_genearator/circle_num", circle_num_, 0);

  n.param("map_genearator/ObstacleShape/lower_rad", _w_l, 0.3);
  n.param("map_genearator/ObstacleShape/upper_rad", _w_h, 0.8);
  n.param("map_genearator/ObstacleShape/lower_hei", _h_l, 3.0);
  n.param("map_genearator/ObstacleShape/upper_hei", _h_h, 7.0);

  n.param("map_genearator/ObstacleShape/radius_l", radius_l_, 7.0);
  n.param("map_genearator/ObstacleShape/radius_h", radius_h_, 7.0);
  n.param("map_genearator/ObstacleShape/z_l", z_l_, 7.0);
  n.param("map_genearator/ObstacleShape/z_h", z_h_, 7.0);
  n.param("map_genearator/ObstacleShape/theta", theta_, 7.0);

  n.param("map_genearator/sensing/radius", _sensing_range, 10.0);
  n.param("map_genearator/sensing/rate", _sense_rate, 10.0);
